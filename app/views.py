...
class ProductView(View):
    def get(self, request):
        ...
        return render (request, "app/index.html", {"topwears":topwears, "bottomwears":bottomwears, "mobiles":mobiles, "totalitem":totalitem})
...
def orders(request):
    ...
    if op:
        ...
        return render(request, "app/Noorder.html")
...
def mobile(request, data=None):
    ...
    if data == None:
        mobiles = Product.objects.filter(category='M')
    elif data == 'Redmi' or data == 'SamSung' or data == 'Nokia' or data == 'MotoRola' or data == 'One-Plus':
...
def topwears(request, data=None):
    ...
    if data == None:
        topwears = Product.objects.filter(category='TW')
    elif data == 'Lee' or data == 'Raymond' or data == 'Pantaloons' or data == 'Mayur':
...
class CustomerRegistrationView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            messages.success(request, 'Congratulation!! Registered Succesfullty')
            form.save()
        return render (request, 'app/customerregistration.html', {'form':form})
